...
class CampaignProductDetailsFooter extends StatefulWidget {

  final Product product;
  final String campaignEndDate;

  CampaignProductDetailsFooter(this.product, this.campaignEndDate);

  @override
  _CampaignProductDetailsFooterState createState() => _CampaignProductDetailsFooterState();
}

class _CampaignProductDetailsFooterState extends State<CampaignProductDetailsFooter> with ChangeNotifier {
  ...
  Future<void> _insertIntoLocalDB(BuildContext context, bool isBuying) async {
    ...
    widget.product.isCampaignOffer = true;
    widget.product.campaignEndDate = widget.campaignEndDate;
