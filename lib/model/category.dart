...
class Category {
  ...
  Category({this.id, this.name, this.image, this.imageLarge, this.url, this.slug,
    this.active, this.featured, this.status, this.subCategories});
  ...
  toJson() {
    ...
    return {
      ...
      "subcategory" : subCategories == null ? jsonEncode(List<SubCategory>().map((subCategory) => subCategory.toJson()).toList()).toString() :
      jsonEncode(subCategories.map((subCategory) => subCategory.toJson()).toList()).toString(),
    };
  }
}
...
class CategoryProducts {
  ...
  CategoryProducts({this.totalProduct, this.perPageProduct, this.products, this.category, this.subCategories});
