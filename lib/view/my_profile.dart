...
class _MyProfileState extends State<MyProfile> implements Connectivity, ProfileContract {
  ...
  void initState() {
    ...
    _presenter = UserPresenter(_connectivity, profileContract: _profileContract);
            ...
            return SafeArea(
              child: Column(
                children: <Widget>[
                  ...
                  MyAppBar(AppLocalization.of(context).getTranslatedValue("profile"),
                    onBackPress: () {
