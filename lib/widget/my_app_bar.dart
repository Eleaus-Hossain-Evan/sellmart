...
class MyAppBar extends StatefulWidget {
  ...
  MyAppBar(this.title, {this.autoImplyLeading = true, this.enableButtons = true, this.subTitle, this.trailing, this.onBackPress, this.onTrailPress});
                  ...
                  Visibility(
                    ...
                    child: GestureDetector(
                      ...
                      child: Padding(
                        ...
                        child: Icon(Icons.arrow_back, size: 6.41 * SizeConfig.imageSizeMultiplier,),
                      ),
                    ),
                  ),
                                  ...
                                  builder: (BuildContext context, int numberOfItem, _) {
                                    ...
                                    return Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: numberOfItem == 0 ? Colors.transparent : Theme.of(context).primaryColor,
                                      ...
                                      child: Text(numberOfItem.toString(),
                                        style: Theme.of(context).textTheme.bodyText2.copyWith(
                                          ...
                                          fontWeight: FontWeight.w500,
                                          color: numberOfItem == 0 ? Colors.transparent : Colors.black,
                                        ),
                                      ),
                                    );
                                  },
