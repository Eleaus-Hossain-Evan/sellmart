...
class _SearchState extends State<Search> implements SearchContract, Connectivity {
            ...
            return SafeArea(
              child: Column(
                children: <Widget>[
                  ...
                  MyAppBar(AppLocalization.of(context).getTranslatedValue("search"),
                    onBackPress: () {
                  ...
                  SearchFilterOption(_typeValue, _sortValue, _minPrice, _maxPrice,
  ...
  void onDisconnected(BuildContext context) {
    ...
    _showSnackMessage(context, AppLocalization.of(context).getTranslatedValue("not_connected"));
  }
  ...
  void onFailure(BuildContext context) {
    ...
    _showSnackMessage(context, AppLocalization.of(context).getTranslatedValue("failed_to_get_data"));
  }
  ...
  void onInactive(BuildContext context) {
    ...
    _showSnackMessage(context, AppLocalization.of(context).getTranslatedValue("inactive_connection"));
  }
  ...
  void onTimeout(BuildContext context) {
    ...
    _showSnackMessage(context, AppLocalization.of(context).getTranslatedValue("connection_time_out"));
  }
  ...
  void _applyFilter() {
    ...
    filterList.forEach((product) {
      ...
      if(product != null && product.currentPrice >= _minPrice && product.currentPrice <= _maxPrice) {
