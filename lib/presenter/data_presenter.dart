...
class DataPresenter with ChangeNotifier {
  ...
  AddressCheckOptions _options = AddressCheckOptions(InternetAddress("8.8.8.8"), port: 53, timeout: Duration(seconds: 2));

  MyOverlayLoader _myOverlayLoader = MyOverlayLoader();

  DataPresenter(Connectivity connectivity, {HomeContract homeContract, CategoryContract categoryContract,
    BrandContract brandContract, ShopContract shopContract, ProductContract productContract,
    ProductDetailContract productDetailContract, SearchContract searchContract, CouponContract couponContract,
    OrderContract orderContract, LocationContract locationContract, CampaignContract campaignContract,
    ReviewContract reviewContract, PolicyContract policyContract}) {
  ...
  void getHomeData(BuildContext context) {
    ...
    con.Connectivity().checkConnectivity().then((result) {
      ...
      if(result == con.ConnectivityResult.mobile || result == con.ConnectivityResult.wifi) {
        ...
        DataConnectionChecker().isHostReachable(_options).then((addressCheck) {
          ...
          if(addressCheck.isSuccess) {
            ...
            client.get(
                ...
                Uri.encodeFull(APIRoute.HOME),
                headers: {"Accept" : "application/json"}

            ).then((response) async {

              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "Home", message: response.body);
        ...
        DataConnectionChecker().isHostReachable(_options).then((addressCheck) {
          ...
          if(addressCheck.isSuccess) {
            ...
            client.get(
                ...
                Uri.encodeFull(APIRoute.ALL_CATEGORY),
                headers: {"Accept" : "application/json"}

            ).then((response) async {

              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "All Category", message: response.body);
        ...
        DataConnectionChecker().isHostReachable(_options).then((addressCheck) {
          ...
          if(addressCheck.isSuccess) {
            ...
            client.get(
                ...
                Uri.encodeFull(APIRoute.ALL_BRAND),
                headers: {"Accept" : "application/json"}

            ).then((response) async {

              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "All Brand", message: response.body);
        ...
        DataConnectionChecker().isHostReachable(_options).then((addressCheck) {
          ...
          if(addressCheck.isSuccess) {
            ...
            client.get(
                ...
                Uri.encodeFull(APIRoute.ALL_SHOP),
                headers: {"Accept" : "application/json"}

            ).then((response) async {

              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "All Shop", message: response.body);
  ...
  void getProducts(BuildContext context, int typeBy, String slug, {int page = 1}) {
          ...
          if(addressCheck.isSuccess) {
            ...
            switch(typeBy) {
              ...
              case Constants.BY_CATEGORY:
                url = APIRoute.PRODUCT_BY_CATEGORY + slug + "?page=" + page.toString() + "&resultsPerPage=30";
                break;

              case Constants.BY_SUBCATEGORY:
                url = APIRoute.PRODUCT_BY_SUB_CATEGORY + slug + "?page=" + page.toString() + "&resultsPerPage=30";
                break;

              case Constants.BY_SUB_SUBCATEGORY:
                url = APIRoute.PRODUCT_BY_SUB_SUB_CATEGORY + slug + "?page=" + page.toString() + "&resultsPerPage=30";
                break;

              case Constants.BY_BRAND:
                url = APIRoute.PRODUCT_BY_BRAND + slug + "?page=" + page.toString() + "&resultsPerPage=30";
                break;

              case Constants.BY_SHOP:
                url = APIRoute.PRODUCT_BY_SHOP + slug + "?page=" + page.toString() + "&resultsPerPage=30";
                break;

              case Constants.BY_DISCOUNT:
                url = APIRoute.ALL_DISCOUNTED + "?page=" + page.toString() + "&resultsPerPage=30";
                break;

              case Constants.BY_WISH_LIST:
                url = APIRoute.ALL_WISH_LIST + currentUser.value.id + "?page=" + page.toString();
                break;
            }
            ...
            client.get(
              ...
              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "Products", message: response.body);
              ...
              if(response.statusCode == 200 || response.statusCode == 201) {
                ...
                if(jsonData['success']) {
                  ...
                  switch(typeBy) {
                    ...
                    case Constants.BY_CATEGORY:
                      CategoryProducts categoryProducts = CategoryProducts.fromJson(jsonData['data']);
                      _productContract.productsByCategory(categoryProducts);
                      break;

                    case Constants.BY_SUBCATEGORY:
                      SubCategoryProducts subCategoryProducts = SubCategoryProducts.fromJson(jsonData['data']);
                      _productContract.productsBySubCategory(subCategoryProducts);
                      break;

                    case Constants.BY_SUB_SUBCATEGORY:
                      SubSubCategoryProducts subSubCategoryProducts = SubSubCategoryProducts.fromJson(jsonData['data']);
                      _productContract.productsBySubSubCategory(subSubCategoryProducts);
                      break;

                    case Constants.BY_BRAND:
                      BrandProducts brandProducts = BrandProducts.fromJson(jsonData['data']);
                      _productContract.productsByBrand(brandProducts);
                      break;

                    case Constants.BY_SHOP:
                      ShopProducts shopProducts = ShopProducts.fromJson(jsonData['data']);
                      _productContract.productsByShop(shopProducts);
                      break;

                    case Constants.BY_DISCOUNT:
                      DiscountedProducts discountedProducts = DiscountedProducts.fromJson(jsonData['data']);
  ...
  void getProductDetails(BuildContext context, String productSlug, {String campaignSlug}) {
        ...
        DataConnectionChecker().isHostReachable(_options).then((addressCheck) {
          ...
          if(addressCheck.isSuccess) {
            ...
            client.get(
              ...
              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "Product Details", message: response.body);
              ...
              if(response.statusCode == 200 || response.statusCode == 201) {
                ...
                if(jsonData['success']) {
                  ...
                  Products similarProducts = Products.fromJson(jsonData['similerProducts']);

                  _productDetailContract.onSuccess(product, similarProducts.list);
                }
                else {
        ...
        DataConnectionChecker().isHostReachable(_options).then((addressCheck) {
          ...
          if(addressCheck.isSuccess) {
            ...
            client.post(
              ...
              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "Add To Wishlist", message: response.body);
              ...
              if(response.statusCode == 200 || response.statusCode == 201) {
                ...
                if(jsonData['success']) {
                  ...
                  _productDetailContract.onFailedToAddOrRemovedWishList(context, AppLocalization.of(context).getTranslatedValue("failed_to_add_in_wishlist"));
                }
              }
              else {
        ...
        DataConnectionChecker().isHostReachable(_options).then((addressCheck) {
          ...
          if(addressCheck.isSuccess) {
            ...
            client.post(
              ...
              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "Remove From Wishlist", message: response.body);
              ...
              if(response.statusCode == 200 || response.statusCode == 201 || response.statusCode == 202) {
                ...
                if(jsonData['success']) {
                  ...
                  _productDetailContract.onFailedToAddOrRemovedWishList(context, AppLocalization.of(context).getTranslatedValue("failed_to_remove_from_wishlist"));
                }
              }
              else {
        ...
        DataConnectionChecker().isHostReachable(_options).then((addressCheck) {
          ...
          if(addressCheck.isSuccess) {
            ...
            client.get(
                ...
                Uri.encodeFull(APIRoute.SEARCH + pattern),
                headers: {"Accept" : "application/json"}

            ).then((response) async {

              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "Search", message: response.body);
        ...
        DataConnectionChecker().isHostReachable(_options).then((addressCheck) {
          ...
          if(addressCheck.isSuccess) {
            ...
            client.get(
                ...
                Uri.encodeFull(APIRoute.VERIFY_COUPON + couponCode),
                headers: {"Accept" : "application/json"}

            ).then((response) async {

              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "Coupon Code", message: response.body);
              ...
              if(response.statusCode == 200 || response.statusCode == 201) {
                ...
                if(jsonData['success']) {
                  ...
                  if(DateTime.parse(coupon.startDate).isBefore(DateTime.now()) && DateTime.parse(coupon.endDate).isAfter(DateTime.now())) {

                    _couponContract.onValid(coupon);
                  }
                  else {

                    _couponContract.onInvalid(context, AppLocalization.of(context).getTranslatedValue("invalid_coupon"));
                  }
                }
                else {
          ...
          if(addressCheck.isSuccess) {
            ...
            items.forEach((item) {
              ...
              if(item != null && item.isChecked) {
                ...
                map['image'] = item.product.thumbnail.split(APIRoute.BASE_URL)[1];
                ...
                if(item.product.variationType == 0 || item.product.variationType == 1) {
                  ...
                  map['variationOne'] = item.product.selectedVariation.value1 ?? "";
                  map['variationTwo'] = item.product.selectedVariation.value2 ?? "";
                }
            ...
            if(order.value.coupon != null && order.value.coupon.code != null && order.value.coupon.code.isNotEmpty) {
            ...
            client.post(
              ...
              headers: {"Authorization": currentUser.value.token, "Accept" : "application/json", "Content-Type" : "application/json"},
              body: json.encode(orderData),

            ).then((response) async {

              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "Order Create", message: response.body);
              ...
              if(response.statusCode == 200 || response.statusCode == 201) {
                ...
                if(jsonData['success']) {
                  ...
                  _orderContract.onFailedToPlaceOrder(context, AppLocalization.of(context).getTranslatedValue("failed_to_place_order"));
                }
              }
              else {
  ...
  Future<void> setPaymentSuccessful(BuildContext context, Order order, SSLCTransactionInfoModel transactionInfo) async {
        ...
        DataConnectionChecker().isHostReachable(_options).then((addressCheck) {
          ...
          if(addressCheck.isSuccess) {
            ...
            client.post(
              ...
              headers: {"Authorization": "Bearer " + currentUser.value.token, "Accept" : "application/json", "Content-Type" : "application/json"},
              body: json.encode(data),

            ).then((response) async {

              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "Payment Success Acknowledge", message: response.body);
              ...
              if(response.statusCode == 200 || response.statusCode == 201) {
                ...
                if(jsonData['success']) {
                  ...
                  _orderContract.onPaymentStatusChangeFailed(context, order, transactionInfo);
                }
              }
              else {
        ...
        DataConnectionChecker().isHostReachable(_options).then((addressCheck) {
          ...
          if(addressCheck.isSuccess) {
            ...
            client.get(
                ...
                Uri.encodeFull(APIRoute.ALL_LOCATION),
                headers: {"Accept" : "application/json"}

            ).then((response) async {

              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "All Location", message: response.body);
              ...
              if(response.statusCode == 200 || response.statusCode == 201) {
                ...
                if(jsonData['success']) {
                  ...
                  Divisions divisions = Divisions.fromJson(jsonData['data']['divisions']);
                  Districts districts = Districts.fromJson(jsonData['data']['districts']);
                  Upazilas upazilas = Upazilas.fromJson(jsonData['data']['upazilas']);

                  _locationContract.onLocationsFetched(divisions.list, districts.list, upazilas.list);
                }
                else {

                  _locationContract.onFailedToGetLocations(context, AppLocalization.of(context).getTranslatedValue("failed_to_get_data"), Constants.FAILURE);
                }
              }
              else {
              ...
              _myOverlayLoader.dismissDialog(context);
              _locationContract.onFailedToGetLocations(context, AppLocalization.of(context).getTranslatedValue("failed_to_get_data"), Constants.TIMEOUT);
            ...
            _locationContract.onFailedToGetLocations(context, AppLocalization.of(context).getTranslatedValue("failed_to_get_data"), Constants.INACTIVE);
          }
        });
      }
      else {
        ...
        DataConnectionChecker().isHostReachable(_options).then((addressCheck) {
          ...
          if(addressCheck.isSuccess) {
            ...
            client.get(
                ...
                Uri.encodeFull(APIRoute.ALL_CAMPAIGN),
                headers: {"Accept" : "application/json"}

            ).then((response) async {

              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "All Campaign", message: response.body);
        ...
        DataConnectionChecker().isHostReachable(_options).then((addressCheck) {
          ...
          if(addressCheck.isSuccess) {
            ...
            client.get(
              ...
              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "Campaign Products", message: response.body);
        ...
        DataConnectionChecker().isHostReachable(_options).then((addressCheck) {
          ...
          if(addressCheck.isSuccess) {
            ...
            client.get(
                ...
                headers: {"Authorization": currentUser.value.token, "Accept" : "application/json"}

            ).then((response) async {

              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "My Orders", message: response.body);
            ...
            client.post(
              ...
              if(response.statusCode == 200 || response.statusCode == 201) {
                ...
                if(jsonData['message'] == Constants.ALREADY_REVIEWED) {
                  ...
                  _reviewContract.onFailedToSubmitReview(context, AppLocalization.of(context).getTranslatedValue("already_reviewed"));
                }
                else {

                  _reviewContract.onFailedToSubmitReview(context, AppLocalization.of(context).getTranslatedValue("failed_to_submit_review"));
                }
              }
      ...
      if(result == con.ConnectivityResult.mobile || result == con.ConnectivityResult.wifi) {
        ...
        DataConnectionChecker().isHostReachable(_options).then((addressCheck) {
          ...
          if(addressCheck.isSuccess) {
            ...
            Map<String, dynamic> data = {
              'cancelOrderReason': message
            };

            client.post(

              Uri.encodeFull(APIRoute.CANCEL_ORDER + currentUser.value.id + "/" + orderID),
              headers: {"Authorization": currentUser.value.token, "Accept" : "application/json"},
              body: data,

            ).then((response) async {

              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "Order Cancel", message: response.body);
              ...
              if(response.statusCode == 200 || response.statusCode == 201) {
                ...
                _orderContract.onFailedCancelOrder(context, AppLocalization.of(context).getTranslatedValue("failed_to_cancel_order"));
              }
        ...
        DataConnectionChecker().isHostReachable(_options).then((addressCheck) {
          ...
          if(addressCheck.isSuccess) {
            ...
            client.get(
                ...
                Uri.encodeFull(APIRoute.PRODUCT_REVIEWS + productID),
                headers: {"Accept" : "application/json"}

            ).then((response) async {

              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "Product Reviews", message: response.body);
        ...
        DataConnectionChecker().isHostReachable(_options).then((addressCheck) {
          ...
          if(addressCheck.isSuccess) {
            ...
            client.get(
              ...
              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "Withdraw Request", message: response.body);
              ...
              if(response.statusCode == 200 || response.statusCode == 201) {
                ...
                _orderContract.onFailedToRequestRefund(context, AppLocalization.of(context).getTranslatedValue("failed_to_refund_requested"));
              }
        ...
        DataConnectionChecker().isHostReachable(_options).then((addressCheck) {
          ...
          if(addressCheck.isSuccess) {
            ...
            client.get(
              ...
              CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "Return-Refund Request", message: response.body);
              ...
              if(response.statusCode == 200 || response.statusCode == 201) {
                ...
                _orderContract.onFailedToRequestReturnRefund(context, AppLocalization.of(context).getTranslatedValue("failed_to_return_refund_requested"));
              }
    ...
    con.Connectivity().checkConnectivity().then((result) {
      ...
      if(result == con.ConnectivityResult.mobile || result == con.ConnectivityResult.wifi) {
        ...
        client.get(
            ...
            Uri.encodeFull(APIRoute.POLICIES),
            headers: {"Accept" : "application/json"}

        ).then((response) async {

          CustomLogger.debug(trace: CustomTrace(StackTrace.current), tag: "Policies", message: response.body);
          ...
          if(response.statusCode == 200 || response.statusCode == 201) {
            ...
            if(jsonData['success']) {
              ...
              _policyContract.onSuccess(jsonData['data']['termsAndCondition'], jsonData['data']['privacyPolicy'], jsonData['data']['refundPolicy']);
            }
            else {
