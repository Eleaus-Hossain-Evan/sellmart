...
class _OrderCouponWidgetState extends State<OrderCouponWidget> with ChangeNotifier {
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(AppLocalization.of(context).getTranslatedValue("promo_code").toUpperCase(),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(.85 * SizeConfig.heightSizeMultiplier),
                    border: Border.all(color: Colors.white, width: .361 * SizeConfig.widthSizeMultiplier),
                  ),
              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(widget.coupon != null && widget.coupon.code != null && widget.coupon.code.isNotEmpty ? widget.coupon.code : "",
                    ...
                    Text(widget.coupon != null && widget.coupon.code != null && widget.coupon.code.isNotEmpty ? (widget.coupon.discount.amount.round().toString() +
                        (widget.coupon.discount.type == Constants.FLAT_DISCOUNT ? (" " + AppLocalization.of(context).getTranslatedValue("tk")) : "%")) : "",
                      style: Theme.of(context).textTheme.bodyText2.copyWith(
                        fontSize: 2 * SizeConfig.textSizeMultiplier,
                        color: Colors.black.withOpacity(.75),
                      ),
                ...
                GestureDetector(
                  ...
                  child: Text(AppLocalization.of(context).getTranslatedValue("remove_coupon"),
                    style: Theme.of(context).textTheme.bodyText2.copyWith(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Icon(Icons.close, size: 6.92 * SizeConfig.imageSizeMultiplier, color: Colors.black.withOpacity(.65),),
                        ),
                      ],
                    ),

                    Text(AppLocalization.of(context).getTranslatedValue("add_promo_code"),
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          enabledBorder: UnderlineInputBorder(
                            borderSide: BorderSide(color: Theme.of(context).primaryColor, width: .5 * SizeConfig.widthSizeMultiplier),
                          ),
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Text(AppLocalization.of(context).getTranslatedValue("done").toUpperCase(),
                              style: Theme.of(context).textTheme.subtitle2.copyWith(
                                color: Colors.white,
                              ),
                            ),
