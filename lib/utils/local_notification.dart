...
class LocalNotification {
  ...
  String campaignChannelDescription =
      "Different campaign and offer notifications";
  ...
  Future<void> generalNotification(String channelID, String channelName,
      String channelDescription, String title, String body) async {
  ...
  Future<void> notificationWithImage(
      String channelID,
      String channelName,
    ...
    if (imageURL != null) {
      final String bigPicturePath =
          await _downloadAndSaveFile(imageURL, "notification_image");
  ...
  Future<void> generalNotificationWithoutSoundAndVibration(
      String channelID,
      String channelName,
      String channelDescription,
      String title,
