      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          return GestureDetector(
            ...
            onTap: () {
              if (widget.products[index].currentStock != null &&
                  widget.products[index].currentStock > 0) {
                if (widget.campaignProduct) {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => CampaignProductDetails(
                              widget.products[index].slug,
                              widget.campaignSlug,
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              ProductDetails(widget.products[index].slug)));
                }
              }
            },
            child: widget.campaignProduct
                ? CampaignProductWidget(widget.products[index])
