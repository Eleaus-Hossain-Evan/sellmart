                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Icon(Ionicons.home,
                          ...
                          color: _currentIndex == Constants.HOME ? Theme.of(context).primaryColor : Colors.black38,
                        ),
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      color: _currentIndex == Constants.HOME ? Theme.of(context).primaryColor : Colors.transparent,
                    ),
                  ),
                ],
              ),
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Image.asset(Images.category,
                          color: _currentIndex == Constants.CATEGORIES ? Theme.of(context).primaryColor : Colors.black38,
                          height: 2.5 * SizeConfig.heightSizeMultiplier,
                          width: 5.12 * SizeConfig.widthSizeMultiplier,
                          fit: BoxFit.fill,
                        ),

                        Text(AppLocalization.of(context).getTranslatedValue("categories"),
                          style: Theme.of(context).textTheme.bodyText2.copyWith(
                            fontWeight: FontWeight.w500,
                            fontSize: 1.5 * SizeConfig.textSizeMultiplier,
                            color: _currentIndex == Constants.CATEGORIES ? Theme.of(context).primaryColor : Colors.black38,
                  ...
                  Align(
                    ...
                    child: Container(
                      height: .25 * SizeConfig.heightSizeMultiplier,
                      width: 10.25 * SizeConfig.widthSizeMultiplier,
                      color: _currentIndex == Constants.CATEGORIES ? Theme.of(context).primaryColor : Colors.transparent,
                    ),
                  ),
                ],
              ),
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Icon(EvaIcons.archive,
                          size: 5.38 * SizeConfig.imageSizeMultiplier,
                          color: _currentIndex == Constants.ORDERS ? Theme.of(context).primaryColor : Colors.black38,
                        ),

                        Text(AppLocalization.of(context).getTranslatedValue("my_orders"),
                          style: Theme.of(context).textTheme.bodyText2.copyWith(
                            fontWeight: FontWeight.w500,
                            fontSize: 1.5 * SizeConfig.textSizeMultiplier,
                            color: _currentIndex == Constants.ORDERS ? Theme.of(context).primaryColor : Colors.black38,
                  ...
                  Align(
                    ...
                    child: Container(
                      height: .25 * SizeConfig.heightSizeMultiplier,
                      width: 10.25 * SizeConfig.widthSizeMultiplier,
                      color: _currentIndex == Constants.ORDERS ? Theme.of(context).primaryColor : Colors.transparent,
                    ),
                  ),
                ],
              ),
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Icon(Icons.local_offer,
                          size: 5.38 * SizeConfig.imageSizeMultiplier,
                          color: _currentIndex == Constants.CAMPAIGN ? Theme.of(context).primaryColor : Colors.black38,
                        ),

                        Text(AppLocalization.of(context).getTranslatedValue("campaign"),
                          style: Theme.of(context).textTheme.bodyText2.copyWith(
                            fontWeight: FontWeight.w500,
                            fontSize: 1.5 * SizeConfig.textSizeMultiplier,
                            color: _currentIndex == Constants.CAMPAIGN ? Theme.of(context).primaryColor : Colors.black38,
                  ...
                  Align(
                    ...
                    child: Container(
                      height: .25 * SizeConfig.heightSizeMultiplier,
                      width: 10.25 * SizeConfig.widthSizeMultiplier,
                      color: _currentIndex == Constants.CAMPAIGN ? Theme.of(context).primaryColor : Colors.transparent,
                    ),
                  ),
                ],
              ),
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Icon(Icons.person,
                          size: 5.38 * SizeConfig.imageSizeMultiplier,
                          color: _currentIndex == Constants.ACCOUNT ? Theme.of(context).primaryColor : Colors.black38,
                        ),

                        Text(AppLocalization.of(context).getTranslatedValue("account"),
                          style: Theme.of(context).textTheme.bodyText2.copyWith(
                            fontWeight: FontWeight.w500,
                            fontSize: 1.5 * SizeConfig.textSizeMultiplier,
                            color: _currentIndex == Constants.ACCOUNT ? Theme.of(context).primaryColor : Colors.black38,
                  ...
                  Align(
                    ...
                    child: Container(
                      height: .25 * SizeConfig.heightSizeMultiplier,
                      width: 10.25 * SizeConfig.widthSizeMultiplier,
                      color: _currentIndex == Constants.ACCOUNT ? Theme.of(context).primaryColor : Colors.transparent,
                    ),
                  ),
                ],
              ),
