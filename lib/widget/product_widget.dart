              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Align(
                    ...
                    child: Visibility(
                      visible: (widget.product.variationType != null && (widget.product.variationType == 0 || widget.product.variationType == 1)) &&
                          (widget.product.variations != null && widget.product.variations.length > 0 && widget.product.variations[0] != null &&
                          widget.product.variations[0].regularPrice != null && widget.product.variations[0].discountPrice != null
                          && widget.product.variations[0].regularPrice != widget.product.variations[0].discountPrice),
                      child: Container(
                        padding: EdgeInsets.only(
                        ...
                        child: Text(widget.product.variations != null && widget.product.variations.length > 0 && widget.product.variations[0] != null &&
                            widget.product.variations[0].discountType != null && widget.product.variations[0].discountAmount != null ?
                            (widget.product.variations[0].discountType == PriceCalculator.AMOUNT ? ("৳" + widget.product.variations[0].discountAmount.round().toString()) :
                            (widget.product.variations[0].discountAmount.round().toString() + "%")) : "",
                  ...
                  Align(
                    alignment: Alignment.topRight,
                    child: Visibility(
                      visible: (widget.product.variationType != null && (widget.product.variationType == 2)) &&
                          (widget.product.sizeInfos != null && widget.product.sizeInfos.length > 0 && widget.product.sizeInfos[0] != null &&
                              widget.product.sizeInfos[0].regularPrice != null && widget.product.sizeInfos[0].discountPrice != null
                              && widget.product.sizeInfos[0].regularPrice != widget.product.sizeInfos[0].discountPrice),
                      child: Container(
                        padding: EdgeInsets.only(
                          top: .475 * SizeConfig.heightSizeMultiplier,
                          bottom: .475 * SizeConfig.heightSizeMultiplier,
                        ...
                        child: Text(widget.product.sizeInfos != null && widget.product.sizeInfos.length > 0 && widget.product.sizeInfos[0] != null &&
                            widget.product.sizeInfos[0].discountType != null && widget.product.sizeInfos[0].discountAmount != null ?
                        (widget.product.sizeInfos[0].discountType == PriceCalculator.AMOUNT ? ("৳" + widget.product.sizeInfos[0].discountAmount.round().toString()) :
                        (widget.product.sizeInfos[0].discountAmount.round().toString() + "%")) : "",
                          style: Theme.of(context).textTheme.bodyText1.copyWith(
                            fontSize: 1.625 * SizeConfig.textSizeMultiplier,
                            color: Colors.white,
                          ),
