...
class Product {
  ...
  Product.fromJson(Map<String, dynamic> json) {
    ...
    try {
      youtubeVideo = List();
      (json['youtubeVideo']).forEach((video) {
        youtubeVideo.add(video);
      });
    } catch (error) {
      youtubeVideo = List();
    }
