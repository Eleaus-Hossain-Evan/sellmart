...
class _MenuWidgetState extends State<MenuWidget> with ChangeNotifier {
      ...
      builder: (BuildContext context, User user, _) {
        ...
        return Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 6.5 * SizeConfig.heightSizeMultiplier,),
            ...
            Visibility(
              ...
              child: ListTile(
                ...
                title: Text(AppLocalization.of(context).getTranslatedValue("profile"),
            ...
            Visibility(
              ...
              child: ListTile(
                ...
                dense: true,
                leading: Image.asset(Images.wishList,
                  height: 3.125 * SizeConfig.heightSizeMultiplier,
                  width: 6.41 * SizeConfig.widthSizeMultiplier,
                  fit: BoxFit.fill,
                ),
                title: Text(AppLocalization.of(context).getTranslatedValue("wish_list"),
                  style: Theme.of(context).textTheme.subtitle2.copyWith(
                    fontWeight: FontWeight.w400,
                  ),
                ),
            ...
            Visibility(
              ...
              child: ListTile(
                ...
                title: Text(AppLocalization.of(context).getTranslatedValue("address"),
                  style: Theme.of(context).textTheme.subtitle2.copyWith(
                    fontWeight: FontWeight.w400,
                  ),
                ),
            ...
            Visibility(
              ...
              child: ListTile(
                ...
                dense: true,
                leading: Image.asset(Images.changePassword,
                  height: 3.125 * SizeConfig.heightSizeMultiplier,
                  width: 6.41 * SizeConfig.widthSizeMultiplier,
                  fit: BoxFit.fill,
                ),
            ...
            Visibility(
              ...
              child: ListTile(
                ...
                dense: true,
                leading: Image.asset(Images.refund,
                  height: 3.125 * SizeConfig.heightSizeMultiplier,
                  width: 6.41 * SizeConfig.widthSizeMultiplier,
                  fit: BoxFit.fill,
                ),
                title: Text(AppLocalization.of(context).getTranslatedValue("return_refund"),
                  style: Theme.of(context).textTheme.subtitle2.copyWith(
                    fontWeight: FontWeight.w400,
                  ),
                ),
            ...
            ListTile(
              ...
              dense: true,
              leading: Image.asset(Images.terms,
                height: 3.125 * SizeConfig.heightSizeMultiplier,
                width: 6.41 * SizeConfig.widthSizeMultiplier,
                fit: BoxFit.fill,
              ),
            ...
            ListTile(
              ...
              dense: true,
              leading: Image.asset(Images.privacy,
                height: 3.125 * SizeConfig.heightSizeMultiplier,
                width: 6.41 * SizeConfig.widthSizeMultiplier,
                fit: BoxFit.fill,
              ),
            ...
            ListTile(
              ...
              dense: true,
              leading: Image.asset(Images.report,
                height: 3.125 * SizeConfig.heightSizeMultiplier,
                width: 6.41 * SizeConfig.widthSizeMultiplier,
                fit: BoxFit.fill,
              ),
              title: Text(AppLocalization.of(context).getTranslatedValue("report_issue"),
                style: Theme.of(context).textTheme.subtitle2.copyWith(
                  fontWeight: FontWeight.w400,
                ),
              ),
            ...
            Visibility(
              ...
              child: ListTile(
                ...
                dense: true,
                leading: Image.asset(Images.information,
            ...
            Visibility(
              ...
              child: ListTile(
                ...
                dense: true,
                leading: Image.asset(Images.translate,
                  height: 3.125 * SizeConfig.heightSizeMultiplier,
                  width: 6.41 * SizeConfig.widthSizeMultiplier,
                  fit: BoxFit.fill,
                ),
            ...
            Visibility(
              ...
              child: ListTile(
                ...
                dense: true,
                leading: Image.asset(Images.enter,
                  height: 3.125 * SizeConfig.heightSizeMultiplier,
                  width: 6.41 * SizeConfig.widthSizeMultiplier,
                  fit: BoxFit.fill,
                ),
                title: Text(AppLocalization.of(context).getTranslatedValue("login"),
                  style: Theme.of(context).textTheme.subtitle2.copyWith(
                    fontWeight: FontWeight.w400,
                  ),
                ),
  ...
  void _onItemClick(int value) {
    ...
    switch(value) {
      ...
      case Constants.REFUND_SETTLEMENT_MENU:
        _openWebViewPage(AppLocalization.of(context).getTranslatedValue("return_refund"), Constants.RETURN_POLICY);
        break;

      case Constants.TERMS_CONDITIONS_MENU:
        _openWebViewPage(AppLocalization.of(context).getTranslatedValue("terms_condition"), Constants.TERMS_CONDITIONS);
        break;

      case Constants.PRIVACY_POLICY_MENU:
        _openWebViewPage(AppLocalization.of(context).getTranslatedValue("privacy_policy"), Constants.PRIVACY_POLICY);
        break;
  ...
  Future<void> _openWebViewPage(String title, int type) async {
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context) => WebView(title, type)));
  }
