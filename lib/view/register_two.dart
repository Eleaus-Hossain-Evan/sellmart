...
class _RegisterTwoState extends State<RegisterTwo>
    implements Connectivity, RegisterContract {
  ...
  void initState() {
    ...
    _presenter =
        UserPresenter(_connectivity, registerContract: _registerContract);
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            MyApp.appLocale.languageCode == ENGLISH
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText: AppLocalization.of(context)
                                        .getTranslatedValue("confirm_password"),
                                    hintStyle: TextStyle(
                                      fontSize:
                                          2 * SizeConfig.textSizeMultiplier,
                                      fontWeight: FontWeight.w700,
  ...
  void _validateForm(BuildContext context) {
    if (_otpController.text.isEmpty) {
      _showToast(AppLocalization.of(context).getTranslatedValue("enter_otp"),
          Toast.LENGTH_SHORT);
    } else {
      if (_otpController.text.length != 4) {
        _showToast(
            AppLocalization.of(context)
                .getTranslatedValue("otp_must_be_4_digits"),
            Toast.LENGTH_SHORT);
      } else {
        if (_passwordController.text.isEmpty) {
          ...
          if (_passwordController.text.length < 6) {
            _showToast(
                AppLocalization.of(context)
                    .getTranslatedValue("password_must_be_6_chars"),
                Toast.LENGTH_SHORT);
          } else {
            if (_confirmPasswordController.text.isEmpty) {
              _showToast(
                  AppLocalization.of(context)
                      .getTranslatedValue("enter_confirm_password"),
                  Toast.LENGTH_SHORT);
            } else {
              if (_passwordController.text != _confirmPasswordController.text) {
                _showToast(
                    AppLocalization.of(context)
                        .getTranslatedValue("password_do_not_match"),
                    Toast.LENGTH_SHORT);
              } else {
                User user = User(
