...
class DeliveryPaymentOptionWidget extends StatefulWidget {
  ...
  @override
  _DeliveryPaymentOptionWidgetState createState() =>
      _DeliveryPaymentOptionWidgetState();
}

class _DeliveryPaymentOptionWidgetState
    extends State<DeliveryPaymentOptionWidget> with ChangeNotifier {
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: order.paymentOption != null &&
                                order.paymentOption.id == _options[index].id
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                      color: order.paymentOption != null &&
                                          ...
                                          : Colors.black12,
                                      width:
                                          .384 * SizeConfig.widthSizeMultiplier,
                                    ),
                                  ),
                                  child: Icon(
                                    Icons.check,
  ...
  void _init() {
    setState(
      () {
        _options.add(
          PaymentOption(
            id: Constants.CASH_ON_DELIVERY,
            name: AppLocalization.of(context).getTranslatedValue("cod"),
            icon: Image.asset(
              Images.cash,
    ...
    if (info.value != null &&
        info.value.onlinePaymentActive != null &&
        info.value.onlinePaymentActive) {
      setState(
        () {
          _options.add(
            PaymentOption(
              id: Constants.ONLINE_PAYMENT,
              name: AppLocalization.of(context)
                  .getTranslatedValue("online_payment"),
              icon: Image.asset(
