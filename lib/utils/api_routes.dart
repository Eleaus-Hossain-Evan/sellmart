class APIRoute {
  ...
  static const String PRODUCT_BY_SUB_SUB_CATEGORY = API_V1 + "product/subsubcategory/";
  ...
  static const String PAYMENT_SUCCESS_ACKNOWLEDGE = API_V1 + "order/mobile/ssl-payment-success";
  static const String CANCEL_ORDER = API_V1 + "order/customer/order-cancel/";
  static const String WITHDRAW_REQUEST = API_V1 + "order/refund/money-withdrawal/customer-request/";
  static const String RETURN_REFUND = API_V1 + "refund/return-refund/customer-request/";
  static const String UPDATE_DEVICE_TOKEN = API_V1 + "customer/device-token/create/";
  ...
  static const String ALL_WISH_LIST = API_V1 + "product/wish-list/customer-product/";
