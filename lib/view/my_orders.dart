...
class _MyOrdersState extends State<MyOrders> implements Connectivity, OrderContract {
            ...
            return SafeArea(
              child: Column(
                children: <Widget>[
                  ...
                  MyAppBar(AppLocalization.of(context).getTranslatedValue("my_orders"),
                    onBackPress: () {
                    ...
                    child: NotificationListener<OverscrollIndicatorNotification>(
                      ...
                      child: ListView.separated(
                        ...
                        separatorBuilder: (BuildContext context, int index) {
                          ...
                          return SizedBox(height: 2.5 * SizeConfig.heightSizeMultiplier,);
                        },
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return GestureDetector(
                            ...
                            onTap: () {
                              ...
                              Navigator.of(context).pushNamed(RouteManager.ORDER_INFO, arguments: _orders[index]);
                            },
