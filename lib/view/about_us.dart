            ...
            return SafeArea(
              child: Stack(
                children: <Widget>[
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: 9.375 * SizeConfig.heightSizeMultiplier),
                                ...
                                Padding(
                                  ...
                                  child: Material(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(info.value.aboutUs ?? "",
                                        textAlign: TextAlign.center,
                                        style: Theme.of(context).textTheme.subtitle2.copyWith(
                                          fontWeight: FontWeight.w400,
                                          color: Colors.grey[700],
                                          height: .175 * SizeConfig.heightSizeMultiplier,
                                          wordSpacing: .512 * SizeConfig.widthSizeMultiplier,
                                        ),
                                      ),
                                    ),
                                  ),
                  ...
                  MyAppBar(AppLocalization.of(context).getTranslatedValue("about_us"),
                    onBackPress: () {
